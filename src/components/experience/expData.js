...
const projects =
    {
        beehyv: {
            Egenio: [
                ...
                'Implemented and trained XGBoost and ARIMA machine learning models utilizing Amazon SageMaker along with meticulously fine-tuning model hyperparameters enhancing its accuracy.',
...
//            ],
        ...
        newage: {
            Dremio: [
                'Significantly improved workflow efficiency by configuring and managing Jenkins pipelines streamlining the software testing workflow through automation for Dremio data lake house. ',
                'Achieved software reliability by developing comprehensive set of Python test scripts, rigorously validating various functionalities, including multi-source integrations and scalability, achieving software robustness.',
