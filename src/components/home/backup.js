...
<Grid container spacing={3} sx={{backgroundColor: 'inherit'}}>
                        ...
                        <Grid item xs={12} lg={6} sx={{backgroundColor: 'inherit', marginTop: '1em', marginBottom: '1em' }}>
    ...
    <List >
      ...
      <ListItem>
        ...
        <ListItemText primary={home.interests} secondary={
<ul class="space-y-4 m-4 text-left text-gray-500 dark:text-gray-700">
    ...
    <svg class="w-3.5 h-3.5 me-2 text-gray-500 dark:text-gray-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
        ...
        <span>MySQL, PSQL, Redis Cache</span>
                        ...
                        {/* Main Content */}
                        <Grid item xs={12} lg={6} sx={{ backgroundColor: 'inherit', marginTop: '1em', marginBottom: '1em', overflow: 'hidden' }}>

<div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{home.summaryTitle}</h5>
    </a>
